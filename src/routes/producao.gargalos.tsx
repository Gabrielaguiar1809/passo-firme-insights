...
const semaforo: Record<string, { cls: string; emoji: string }> = {
  Normal: { cls: "border-success/40 bg-success/5", emoji: "🟢" },
  Atenção: { cls: "border-warning/40 bg-warning/5", emoji: "🟡" },
  Atrasado: { cls: "border-destructive/40 bg-destructive/5", emoji: "🔴" },
};
